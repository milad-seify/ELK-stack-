...
openssl req -new -key node3-key.pem -subj "/C=CA/ST=ONTARIO/L=TORONTO/O=ORG/OU=UNIT/CN=node3.dns.a-record" -out node3.csr
echo 'subjectAltName=DNS:node3.dns.a-record' > node3.ext
